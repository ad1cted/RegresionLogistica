...
df = df.drop(columns="edad") #x
df = df.drop(columns="ciudadania") #x
df = df.drop(columns="etnia") #x
df = df.drop(columns="nivel_educacion") #x
df = df.drop(columns="otros_ingresos") #x
df = df.drop(columns="deuda") #x
